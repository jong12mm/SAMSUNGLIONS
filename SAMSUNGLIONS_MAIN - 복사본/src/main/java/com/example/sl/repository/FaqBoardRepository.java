...
public interface FaqBoardRepository extends JpaRepository<FaqBoardEntity, Long> {
    ...
    Page<FaqBoardEntity> findByBoardTitleContainingOrderByIdDesc(String title, Pageable pageable);

    Page<FaqBoardEntity> findByBoardWriterContainingOrderByIdDesc(String writer, Pageable pageable);

    Page<FaqBoardEntity> findByBoardContentsContainingOrderByIdDesc(String contents, Pageable pageable);
