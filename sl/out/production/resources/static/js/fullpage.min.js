...
!function (n, t) {
    ...
    var o = window, r = document,
        a = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/) || navigator.userAgent.includes("Mac") && "ontouchend" in document,
    ...
    var He, We, Ve = {
        xn: null, kn: !0, jn: !0, On: null, Ln: null, Dn: function (n) {
            ...
            He = t, Y(Tt().onScrollOverflow) && Xt("onScrollOverflow", {
                position: t,
                direction: e
            }), m(n.target, at) && dn.G && Ve.isScrolled(e, n.target) && Ve.Nn() && Ve.bn(pn().I.item) && vn.R(An, {direction: e})
        })
    };
    ...
    function _e(n, t, e) {
        ...
        l.Bn = (i = l.prevSlideIndex, o = l.slideIndex, i == o ? "none" : i > o ? "left" : "right"), l.direction = l.direction ? l.direction : l.Bn, l.localIsResizing || hn({G: !1}), Tt().onSlideLeave && !l.localIsResizing && "none" !== l.Bn && Y(Tt().onSlideLeave) && !1 === Xt("onSlideLeave", l) ? hn({W: !1}) : (L(t, Kn), D(W(t), Kn), Qe(), l.localIsResizing || (ne(l.prevSlide), te(t)), function (n) {
            ...
            if (i = t.slidesNav, o = t.slideIndex, Tt().slidesNavigation && null != i && (D(p(qn, i), Kn), L(p("a", p("li", i)[o]), Kn)), hn({scrollX: Math.round(r.left)}), Tt().css3) {
                ...
                f.test.Hn[t.sectionIndex] = a, y(It(p(ot, n)), Ht(a)), clearTimeout(We), We = setTimeout((function () {
                    qe(t)
                }), Tt().scrollingSpeed)
    ...
    function Je(n) {
        if (!n) return null;
        var t = n ? n.item : null, e = n.cn ? dn.vn : dn.I.Wn;
        if (t) {
            var i = Lt(e, t);
    ...
    var ni = function (n) {
        var t = this;
        [].push.call(arguments, Tt().sectionSelector), jt.apply(this, arguments), this.Sn = p(Tt().slideSelector, n), this.Wn = Array.from(this.Sn).map((function (n) {
            return new ei(n, t)
        ...
        9 === t ? function (n) {
                ...
                if (!function (n) {
                    ...
                    if (l || !t && u) {
                        ...
                        var c = function (n) {
                            ...
                            do {
                                (i = io(o.item)).length && (t = {Yn: o, $n: i[n ? i.length - 1 : 0]}), o = Ft(o[e]())
                            } while (o && 0 === i.length);
                            return t
                        }(l), f = c ? c.Yn : null;
                        if (f) {
            ...
            !function (n) {
                var t = n.shiftKey, e = r.activeElement, i = Q(e, "video") || Q(e, "audio"),
                    o = Ve.isScrolled("up", pn().I.item), a = Ve.isScrolled("down", pn().I.item),
    ...
    function io(n) {
        return [].slice.call(p('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], summary:not([disabled]), [contenteditable]', n)).filter((function (n) {
    ...
    function uo(n) {
        var t = (new Date).getTime(), e = m(p(".fp-completely")[0], "fp-normal-scroll"), i = function (n, t) {
            (new Date).getTime();
            var e = pn().B && n.getBoundingClientRect().bottom >= 0 && "up" === hi._n(), i = pn().Kn;
            if (i) return V(t), !1;
            if (pn().B) {
                if (e) {
                    var o;
                    if (!(i || Si("isNewKeyframe", "beyondFullpage") && hi.Un())) return (o = zt(rn(pn().C).item.offsetTop + rn(pn().C).item.offsetHeight)).element.scrollTo(0, o.options), hn({Kn: !1}), V(t), !1;
    ...
    function fo(n) {
        n ? (ao(!0), function () {
            if (Ci.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.qn, Vi, {passive: !1}), Kt.addEventListener(Ci.qn, Vi, {passive: !1}));
                var n = Tt().touchWrapper;
                n.removeEventListener(Ci.Gn, Bi), n.removeEventListener(Ci.qn, Ii, {passive: !1}), n.addEventListener(Ci.Gn, Bi), n.addEventListener(Ci.qn, Ii, {passive: !1})
            }
        }()) : (ao(!1), function () {
            if (Ci.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.qn, Ii, {passive: !1}), Kt.removeEventListener(Ci.qn, Vi, {passive: !1}));
                var n = Tt().touchWrapper;
    ...
    function po(n) {
        ...
        })), !e && f.shared.Xn && (fo(!0), f.shared.Xn = !1))) : fo(!0)
    }
    ...
    function Oo() {
        if (!dn.U && !Tt().lockAnchors) {
            ...
            t && t.length && (t && t !== dn._ && !i || o || !dn.W && dn.K != e) && vn.R(xn, {Qn: t, slideAnchor: e})
        }
    }
    ...
    function Uo(n, t) {
        ...
        if (Kt = p("body")[0], qt = p("html")[0], Gt = p("html, body"), !m(qt, _n)) return "touchWrapper", e = "string" == typeof n ? p(n)[0] : n, gt.touchWrapper = e, function (n) {
            ...
            return {options: Tt()}
        }, f.version = "4.0.22", f.test = Object.assign(f.test, {
            top: "0px",
    ...
    return vn.D(Tn, (function () {
        ...
        vn.D(yn, (function () {
            var t, u, l;
            hn({
                Zn: (Tt().licenseKey, t = Tt().licenseKey, u = function (t) {
        ...
        var n = ["-"], t = "2024-0-31".split("-"), e = new Date(t[0], t[1], t[2]),
            i = ["se", "licen", "-", "v3", "l", "gp"];
    ...
    }(), f.setKeyboardScrolling = Co, f.shared.nt = No, f.setAllowScrolling = Bo, f.destroy = function (n) {
